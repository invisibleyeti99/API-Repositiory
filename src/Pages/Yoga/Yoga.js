...
const Yoga = () => {
  ...
  <div className="yoga common">
                ...
                <div className="details">
                    <div className="pl-6"><h1>Sukhasana </h1></div>
                    <h3 className='font-serif'>This sitting posture is recommended for those who have difficulty sitting for a long period of time in Siddhasana, Vajrasana or Padmasana.</h3><br/>
                    <p className='text-black'>Sit with the legs straight. Bend both legs and place the right foot under the left thigh and the left foot under, or in front of, the right calf on the floor. If it is more comfortable cross the legs in the opposite way. If it is difficult to keep the body upright then sit on a cushion at an appropriate height to make the posture comfortable.<br/><br/>
           ...
           <div className="yoga2 common pb-32">
